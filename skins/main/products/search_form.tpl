...
<div class="input_field_0">
    ...
    {include file='main/select/availability_product.tpl' name="posted_data[status][]" value=$search_prefilled.status[0]}
</div>
...
<div class="input_field_0">
    <label>{$lng.lbl_product_created_by}</label>
    {include file='main/select/find_user.tpl' name='posted_data[created_by]' value=$search_prefilled.created_by form='search_form' area='A'}
</div>
