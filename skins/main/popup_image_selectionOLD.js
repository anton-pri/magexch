...
function popup_image_selection (type, id, imgid, tabs) {
    ...
    $('#image_dialog').html("<iframe frameborder='no' width='628' height='225' src='index.php?target=image_selection&type="+type+"&id="+id+"&imgid="+imgid+"&tabs="+tabs+"'></iframe>");
    // Show dialog
    sm('image_dialog', 630, 265, true, 'Select image');
}
