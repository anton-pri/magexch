{*include file='common/page_title.tpl' title=$lng.lbl_profit_reports*}
...
{if $mode eq 'search'}
  {capture name=block}
      ...
      <div class="row">
        <div class="col-sm-12">
          {include file='addons/orders_extra_features/admin/profit_reports_list.tpl'}
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6">{include file='common/per_page.tpl'}</div>
  ...
  {/capture}
  {include file="admin/wrappers/block.tpl" content=$smarty.capture.block title=$lng.lbl_profit_reports}
{/if}
{/capture}
{include file="admin/wrappers/section.tpl" content=$smarty.capture.section extra='width="100%"' title=$lng.lbl_profit_reports}
