...
(function (window, document, undefined) {
    ...
    var log = function (msg) {
        ...
        }, nextButton, H2C_IGNORE = "data-html2canvas-ignore",
        currentPage, modalBody = document.createElement("div");
    window.Feedback = function (options) {
        ...
        var button, modal, currentPage, glass = document.createElement("div"),
            returnMethods = {
                open: function () {
                ...
                send: function (adapter) {
                    ...
                    adapter.send(data, function (success) {
                        ...
                        if (success == 0) {
                            ...
                            var errors = ["", "Empty data", "Empty image", "Wrong image", "Saving error", "Request error"];
                            modalBody.appendChild(document.createTextNode(options.messageError + " (" + errors[success] + ")"))
                        }
                    })
                }
            };
        ...
        options = options || {};
        if (document.getElementById('send_feedback_button')) {
    ...
    window.Feedback.Screenshot.prototype.render = function () {
        ...
        if (window.html2canvas === undefined && script === undefined) {
            ...
            script.src = options.h2cPath || app_web_dir + '/skins/addons/feedback_report/js/html2canvas.min.js';
    ...
    window.Feedback.Screenshot.prototype.data = function () {
        ...
        if (this.h2cCanvas !== undefined) {
            ...
            try {
                return (this._data = this.h2cCanvas.toDataURL('image/jpeg', 0.7))
            } catch (e) {}
        }
    };
...
$(document).ready(function () {
    Feedback({
        h2cPath: app_web_dir + '/skins/addons/feedback_report/js/html2canvas.min.js',
        url: current_location + '/index.php?target=save_feedback_data'
    })
});
