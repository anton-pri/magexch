...
<input type="hidden" name="offer_id" value="{$offer_data.offer_id}" />
...
{/capture}
{include file="admin/wrappers/section.tpl" content=$smarty.capture.section extra='width="100%"' title=$lng.lbl_ps_modify_offer}
