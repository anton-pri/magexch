...
<input type="text" name="posted_data[substring]" value="{$search_prefilled.substring}{*$lng.lbl_search_input*}" placeholder="{$lng.lbl_search}" />
{include file='buttons/go_search.tpl' href="javascript: cw_submit_form('products_search_form');" button_title=$lng.lbl_search style='go'}
