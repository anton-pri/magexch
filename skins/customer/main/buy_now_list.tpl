...
{include file='buttons/button.tpl'  button_title=$lng.lbl_add_2_wishlist href="javascript: cw_submit_form('buy_now_list_`$product.product_id`_`$buy_now_postfix`', 'add2wl');"}
{/if}
