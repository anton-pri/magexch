...
{/if}{* $logs ne "" *}
{/capture}
{include file="admin/wrappers/block.tpl" content=$smarty.capture.section title=$lng.lbl_search_results}
{/if}{* $show_results ne "" *}
{/capture}
{include file="admin/wrappers/section.tpl" content=$smarty.capture.section title=$lng.lbl_shop_logs}
