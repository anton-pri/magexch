<form action="index.php?target={$current_target}&user={$user}" method="post" name="photos_form">
...
<form action="index.php?target={$current_target}&user={$user}" method="post" name="upload_form">
<input type="hidden" name="mode" value="{$mode}" />
