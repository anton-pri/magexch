...
{include file='admin/users/address_book.tpl' class='address_book' addresses=$userinfo.addresses}
</div>
...
{include file='admin/users/sections/address_select.tpl' addresses=$userinfo.addresses value=$userinfo.main_address.address_id name="update_fields[address][main_address_id]" is_main=1}
</div>
