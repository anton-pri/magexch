...
{/capture}
{include file='admin/wrappers/block.tpl' title=$lng.lbl_find_user content=$smarty.capture.section style="hide"}
...
{include file='admin/buttons/button.tpl' button_title=$lng.lbl_set_account href="javascript:set_user();" style="btn-green"}
</div>
</form>

{/capture}
{include file='admin/wrappers/block.tpl' title=$lng.lbl_search_results content=$smarty.capture.list}
