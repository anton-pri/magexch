...
<form action="index.php?target={$current_target}" method="post" name="section_accessories_form">
...
<thead>
<tr>
    <th align="center" style="width:10px;"><input type='checkbox' class='select_all' class_to_select='accessories_item' /></th>
...
{if $accessories}
{foreach from=$accessories item=sec}
<tr{cycle values=", class='cycle'"}>
    <td align="center"><input type="checkbox" name="data[{$sec.id}][del]" value="Y" class="accessories_item" /></td>
    <td>
...
{/foreach}
<tr><td colspan="6">{include file='admin/buttons/button.tpl' href="javascript:document.section_accessories_form.submit();" button_title=$lng.lbl_update_delete style="btn-danger"}</td></tr>
{else}
<tr>
...
<tr>
    <td colspan="2">
		{product_selector name_for_id='newproduct_id' name_for_name='newproduct' prefix_id='section_accessories_form' hide_id_field=1 form='section_accessories_form'}
    </td>
...
<div class="buttons">{include file='admin/buttons/button.tpl' href="javascript:cw_submit_form(document.section_accessories_form, 'add');" button_title=$lng.lbl_add acl='__1207' style="btn-green push-20"}
</div>
