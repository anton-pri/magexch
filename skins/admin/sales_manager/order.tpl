...
{include file='buttons/button.tpl' button_title=$lng.lbl_modify href="index.php?target=modify_salesman_order&doc_id=`$doc_id`&mode=init"}
...
{include file='buttons/button.tpl' button_title=$lng.lbl_send_order_to_customer href="index.php?target=salesman_order&doc_id=`$doc_id`&mode=approve&orders=`$orders`"}
