...
<form action="index.php?target=modify_salesman_order&doc_id={$doc_id}" method="post" name="editpoduct_form">
...
{include file="addons/product_options/customer/products/product-amount.tpl" product_options=$product.display_options cname=$cname disable=$product.deleted nojs='Y'}
...
{/capture}
{include file="common/section.tpl" title=$lng.lbl_modify_order content=$smarty.capture.section extra='width="100%"'}
