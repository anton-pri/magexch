...
replace into cw_languages (code, name, value, topic) values ('EN', 'txt_category_clone_confirmation', 'Do you really want to clone this category?', 'Text');
replace into cw_languages (code, name, value, topic) values ('EN', 'txt_please_enter_cloned_category_name', 'Please enter the name for cloned category.', 'Text');
