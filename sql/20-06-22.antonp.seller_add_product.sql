...
replace into cw_attributes (name,type,field,active,orderby,addon,item_type,is_show_addon,protection) 
values ("Left Description Box ('Contents Listing' for  Magazine issues)",'textarea', 'magexch_product_left_box', 1, 210, 'custom_magazineexchange', 'P', 1, 15);
replace into cw_attributes (name,type,field,active,orderby,addon,item_type,is_show_addon,protection) 
values ("Right Description Box ('Article snippets' for  Magazine issues) (Optional)",'textarea', 'magexch_product_right_box', 1, 220, 'custom_magazineexchange', 'P', 1, 15);
