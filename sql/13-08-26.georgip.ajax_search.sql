...
delete from cw_config_categories where category='ajax_search';
delete from cw_config where name in ('as_suggested_products','as_number_chars');
INSERT INTO `cw_config_categories` (`config_category_id` ,`category` ,`is_local`) VALUES (NULL , 'ajax_search', '0');
