...
insert into cw_datahub_main_data_images (item_id, filename, web_path, system_path) select ID, cimageurl_temp, cimageurl_temp, cimageurl_temp from cw_datahub_main_data where cimageurl_temp != '';
