...
$columns = cw_datahub_get_buffer_table_fields();

$match_items_column_id = -1;
foreach ($columns as $col) {
    if ($col['db'] == 'Match Items') {
        $match_items_column_id = $col['dt']; break;
    } 
}
...
echo json_encode(
    $sent_data = cw_datahub_prepare_display_buffer(SSP::simple( $_POST, $sql_details, $table, $primaryKey, $columns ), $match_items_column_id)
);
