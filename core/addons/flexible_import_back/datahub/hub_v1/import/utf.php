...
$sql = "SELECT * FROM  feeds_item_compare WHERE Source <> 'Hub'";
$result = mysql_query($sql);

while ($row = mysql_fetch_array($result)) { 
	$sql = "UPDATE  feeds_item_compare
					SET Wine = '" . remove_accents(utf8dec($row['Wine'])) . "',
					Producer = '" . remove_accents(utf8dec($row['Producer'])) . "',
					Name = '" . remove_accents(utf8dec($row['Name'])) . "'
