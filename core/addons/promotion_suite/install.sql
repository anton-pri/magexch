INSERT INTO `cw_addons` (`addon`, `descr`, `active`, `status`, `parent`, `version`, `orderby`) VALUES ('promotion_suite', 'Promotion suite', 1, 0, '', '0.1', -1);

INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_offers', 'Offers', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_modify_offer', 'Modify Offer', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_details', 'Offer details', 'Labels'), ('EN', 'lbl_ps_offer_date', 'Offer period', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_offer_title', 'Offer title', 'Labels'), ('EN', 'lbl_ps_unknown', 'n/a', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_offer_desc', 'Offer description', 'Labels'), ('EN', 'lbl_ps_offer_active', 'Active', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_offer_position', 'Position', 'Labels'), ('EN', 'lbl_ps_offer_image', 'Image', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_button_save', 'Save', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_manage_offers', 'Manage Offers', 'Labels'), ('EN', 'msg_ps_empty_fields', 'All the required offer fields should be filled in.', 'Text');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'msg_ps_incorrect_field_type', 'Incorrect type of the field: {{field_name}}.', 'Text'), ('EN', 'msg_ps_updated_succes', 'Offers have been successfully updated.', 'Text');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_offer_details', 'Details', 'Labels'), ('EN', 'lbl_ps_offer_bonuses', 'Bonuses', 'Labels');
INSERT INTO `cw_languages` (`code`, `name`, `value`, `topic`) VALUES ('EN', 'lbl_ps_offer_conditions', 'Conditions', 'Labels');


INSERT INTO `cw_available_images` VALUES ('ps_offer_images','U',0,70,1,'default_image_70.gif');
...
INSERT INTO `cw_menu` ( `menu_id` , `parent_menu_id` , `title` , `link` , `orderby` , `area` , `access_level` , `addon` , `is_loggedin`) VALUES ( NULL , '3', 'lbl_ps_offers', 'index.php?target=promosuite', '400', 'A', '33', 'promotion_suite', '1');
...
CREATE TABLE IF NOT EXISTS `cw_ps_offers` (
  ...
  `repeatable` int(11) NOT NULL DEFAULT '1' COMMENT 'times for repeatable offers',
