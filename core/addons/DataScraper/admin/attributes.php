...
*/    
     ...
     */
    $attributes_tbl_fields = cw_call('cw\\'.addon_name.'\\cw_datascraper_get_table_fields', array('attributes'));

    $smarty->assign('attributes_tbl_fields', $attributes_tbl_fields);
    ...
    $smarty->assign('main', 'datascraper_attributes');   
    return $object;
}
