...
$attributes = cw_func_call('cw_attributes_get', array('item_type' => 'C','attribute_fields'=>array('g:google_product_category')));

if($key == 'root') {
    foreach ($attributes["g:google_product_category"]["default_value"] as $attribute) {
