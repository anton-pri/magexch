...
$table = cw_datahub_import_buffer_view_table_name(true);
...
echo json_encode(
    $sent_data = cw_datahub_prepare_display_buffer(SSP::simple( $_POST, $sql_details, $table, $primaryKey, $columns ), $column_ids, true)
);
