...
cw_flush("Creating ".$config['extension_empowerwine']['prod_option_cart_name']." options");
...
db_query("update cw_products_images_det set image_path=replace(image_path,'http://library.bevnetwork', 'https://library.bevnetwork') where image_path like 'http://library.bevnetwork.com%'");
db_query("update cw_products_images_thumb set image_path=replace(image_path,'http://library.bevnetwork', 'https://library.bevnetwork') where image_path like 'http://library.bevnetwork.com%'");
...
//cw_header_location("index.php?target=datahub_after_import_linked_items");
