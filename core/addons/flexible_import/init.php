...
$tables['datahub_interim_import_buffer'] = 'cw_datahub_interim_import_buffer';
$tables['datahub_update_nonstock_preview'] = 'cw_datahub_update_nonstock_preview';

$tables['datahub_pos_export_changed'] = 'cw_datahub_pos_export_changed';
$tables['datahub_pos_export_new'] = 'cw_datahub_pos_export_new';
...
$tables['datahub_update_nonstock_config'] = 'cw_datahub_update_nonstock_config';
...
$tables['datahub_vias_weekly'] = 'cw_datahub_vias_weekly';
$tables['datahub_vias_monthly'] = 'cw_datahub_vias_monthly';
$tables['datahub_vias_combined'] = 'cw_datahub_vias_combined';

$tables['datahub_products_backups'] = 'cw_datahub_products_backups';

$tables['datahub_buffer_items_likeness'] = 'cw_datahub_buffer_items_likeness';

$tables['history_products_status'] = 'cw_history_products_status';

$tables['datahub_price_levels'] = 'cw_datahub_price_levels';

$var_dirs['flex_import_test'] = $app_dir.'/files/flex_import_test';
$var_dirs['flexible_import'] = $app_dir.'/files/flexible_import';
$var_dirs['flex_import_images'] = $app_dir.'/images';
$var_dirs['products_backups'] = $app_dir.'/files/products_backups';


define ("fi_addons_names_set", "'custom_magazineexchange', 'clean_urls'");
define ("fi_files_path", "./files/flexible_import/");

$cw_allowed_tunnels[] = 'cw_flexible_import_log_list_files';

$cw_allowed_tunnels[] = 'cw_flexible_import_add_prefix';
$cw_allowed_tunnels[] = 'cw_datahub_get_buffer_sources';
...
//      'MEMBERSHIP'
    ...
    'PRODUCTS' => array(
        ...
        'PRODUCTS_CATEGORIES_ORDERBY' => array('type' => 'int'),
...
//      'DEL_STATS'
    ...
    'PRODUCTS_EXTRA_FIELD_VALUES' => array(
        ...
        'PRODUCTCODE' => array('type' => 'text', 'key' => true),
        'PRODUCT' => array('type' => 'text', 'key' => true),
        'dynamic_field_set' => array('query'=>"select field from $tables[attributes] where item_type='P' and addon in ('', ".fi_addons_names_set.")")
    ),
    'CATEGORIES_EXTRA_FIELD_VALUES' => array(
        'CATEGORYID' => array('type' => 'int', 'key' => true),
        'dynamic_field_set' => array('query'=>"select field from $tables[attributes] where item_type='C' and addon in ('', ".fi_addons_names_set.")")
    ),
    'DETAILED_IMAGES' => array(
        'PRODUCTID' => array('type' => 'int', 'key' => true),
        'PRODUCTCODE' => array('type' => 'text', 'key' => true),
        'IMAGE1' => array('type' => 'text'),
        'IMAGE2' => array('type' => 'text'),
        'IMAGE3' => array('type' => 'text'),
        'IMAGE4' => array('type' => 'text'),
        'IMAGE5' => array('type' => 'text'),   
    ),
);
...
if (APP_AREA == 'cron') {
    ...
    cw_include('addons/flexible_import/include/func.products_backups.php');
...
if (APP_AREA == 'customer') {
    ...
    //cw_set_controller(APP_AREA.'/datahub_load_feeds_interim.php', 'addons/flexible_import/datahub/load_feeds_interim.php', EVENT_REPLACE);
    cw_set_controller(APP_AREA.'/datahub_gen_matches_interim.php', 'addons/flexible_import/datahub/gen_matches_interim.php', EVENT_REPLACE);

    cw_set_controller(APP_AREA.'/datahub_calc_output_cron.php', 'addons/flexible_import/datahub/calc_output_cron.php', EVENT_REPLACE);
...
//--------data hub----------------------
    ...
    $dh_buffer_table_fields = array(
        ...
        'Department' => array('edit_type'=>'text'),
        ...
        'Description' => array('excl_list' => false),
        ...
        'bot_qty2' => array('title'=>'Qty2', 'no_edit' => true),
        'cost_per_case2' => array('title'=>'Cost/case2', 'no_edit' => true),
        'cost_per_bottle2' => array('title'=>'Cost2', 'no_edit' => true),
        'bot_qty3' => array('title'=>'Qty3', 'no_edit' => true),
        'cost_per_case3' => array('title'=>'Cost/case3', 'no_edit' => true),
        'cost_per_bottle3' => array('title'=>'Cost3', 'no_edit' => true),
        'bot_qty4' => array('title'=>'Qty4', 'no_edit' => true),
        'cost_per_case4' => array('title'=>'Cost/case4', 'no_edit' => true),
        'cost_per_bottle4' => array('title'=>'Cost4', 'no_edit' => true),
        'bot_qty5' => array('title'=>'Qty5', 'no_edit' => true),
        'cost_per_case5' => array('title'=>'Cost/case5', 'no_edit' => true),
        'cost_per_bottle5' => array('title'=>'Cost5', 'no_edit' => true),
        'bot_qty6' => array('title'=>'Qty6', 'no_edit' => true),
        'cost_per_case6' => array('title'=>'Cost/case6', 'no_edit' => true),
        'cost_per_bottle6' => array('title'=>'Cost6', 'no_edit' => true),
        'manual_price' => array('excl_list' => true),
        'twelve_bot_manual_price' => array('excl_list' => true)
    );
...
*/
    ...
    $dh_main_table_fields = array(
        ...
        'dup_catid' => array('main_display' => 1, 'disabled' => false, 'title'=>'Duplicate ID'),
        ...
        'country' => array('main_display' => true, 'buffer_match_preview'=>true),
        ...
        'drysweet' => array('main_display' => 1, 'title' => 'Department'), 
        'Appellation' => array('main_display' => true, 'buffer_match_preview'=>true),
        'sub_appellation' => array('main_display' => 1, 'title' => 'Sub-appellation', 'buffer_match_preview'=>true),
        'LongDesc' => array('type' => 'textarea', 'title' => 'Description', 'main_display' => 1, "item_select_popup_searchable_off"=>1),
        'RP_Review' => array('type' => 'textarea', 'title' => 'Robert Parker Review'),
        'RP_Rating' => array('title' => 'Robert Parker Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'WS_Review' => array('type' => 'textarea', 'title' => 'Wine Spectator Review'),
        'WS_Rating' => array('title' => 'Wine Spectator Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'WE_Review' => array('type' => 'textarea', 'title' => 'Wine Enthusiast Review'), 
        'WE_Rating' => array('title' => 'Wine Enthusiast Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'DC_Review' => array('type' => 'textarea', 'title' => 'Decanter Review'),
        'DC_Rating' => array('title' => 'Decanter Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'ST_Review' => array('type' => 'textarea', 'title' => 'Stephen Tanzer Review'),
        'ST_Rating' => array('title' => 'Stephen Tanzer Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'W_S_Review' => array('type' => 'textarea', 'title' => 'Wine & Spirits Review'),
        'W_S_Rating' => array('title' => 'Wine & Spirits Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'BTI_Review' => array('type' => 'textarea', 'title' => 'Beverage Tasting Institute Review'),
        'BTI_Rating' => array('title' => 'Beverage Tasting Institute Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'Winery_Review' => array('type' => 'textarea', 'title' => 'Winery Review'),
        'Winery_Rating' => array('title' => 'Winery Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'CG_Review' => array('type' => 'textarea', 'title' => 'Connoisseurs Guide Review'),
        'CG_Rating' => array('title' => 'Connoisseurs Guide Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'JH_Review' => array('type' => 'textarea', 'title' => 'James Halliday Review'),
        'JH_Rating' => array('title' => 'James Halliday Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'MJ_Review' => array('type' => 'textarea', 'title' => 'Michael Jackson Review'), 
        'MJ_Rating' => array('title' => 'Michael Jackson Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        'TWN_Review' => array('type' => 'textarea', 'title' => 'The Wine News Review'),
        'TWN_Rating' => array('title' => 'The Wine News Rating', 'type' => 'select', 'is_rating'=>true, 'main_display' => true),
        ...
        'cost' => array('main_display' => 0, 'buffer_match_preview' => true),  
        'stock' => array('main_display' => 0),
        ...
        'wholesaler' => array('main_display' => 0)
    );
/*
...
*/
    ...
    $datahub_browse_tables = array('item_xref', 'pos', 'cw_datahub_main_data', /*'cw_qbwc_pos_items_buffer'=>array('table_func'=>'cw_dt_dh_browser_qpib', 'p_key'=>'buffer_id'),*/ 'item', 'xfer_products_SWE'=>array('p_key'=>'catalogid'), 'item_price'=>array('p_key'=>'item_id'), 'item_price_twelve_bottle'=>array('p_key'=>'item_id'), 'item_store2', 'SWE_store_feed', 'Supplier', 'cw_qbwc_pos_items_buffer_fixitems171020'=>array('p_key'=>'buffer_id'), 'BevAccessFeeds', 'cw_datahub_BevAccessFeeds', 'cw_products_prices');

    global $dh_browse_linked_keys;
    $dh_browse_linked_keys = array(
    'alu' => array('item_xref'=>'item_id',
                   'pos' => 'Alternate Lookup',
                   'cw_datahub_main_data' => 'catalog_id',
                   'cw_qbwc_pos_items_buffer_view' => 'ALU',
                   'xfer_products_SWE' => 'catalogid',
                   'item_price' => 'item_id',
                   'item_price_twelve_bottle' => 'item_id',
                   'item_store2' => 'item_id',
                   'cw_products_prices' => 'product_id'
                   ),
    'sku' => array('pos' => 'Item Number',
                   'cw_datahub_main_data' => 'store_sku',
                   'cw_qbwc_pos_items_buffer_view' => 'ITEMNUMBER',
                   'xfer_products_SWE' => 'sku',
                   'item_price' => 'store_sku',
                   'item_store2' => 'store_sku',
                   'SWE_store_feed' => 'sku' 
                   ),
    'xref' => array('item_xref'=>'xref',
                    'pos'=>"Custom Field 5",
                    'cw_datahub_main_data'=>'initial_xref',
                    'cw_qbwc_pos_items_buffer_view'=>"X-REFt",
                    'xfer_products_SWE' => 'ccode',
                    'item_price' => 'xref',
                    'cw_datahub_BevAccessFeeds' => 'xref',
                    'BevAccessFeeds' => 'xref'
                    ),
    //'supplierid' => array('item_xref'=>'supplier_id', 'Supplier'=>'supplier_id'),  
    );
    ...
    if (in_array($target,array('datahub_buffer_match','datahub_interim_buffer_match','datahub_item_select_popup'))) { 
    ...
    if ($target == 'datahub_main_edit' || $target == 'datahub_update_nonstock') {
    ...
    cw_addons_set_controllers(
        ...
        array('replace', 'admin/datahub_interim_buffer_match.php', 'addons/flexible_import/datahub/interim_buffer_match.php'),
        array('replace', 'admin/datahub_interim_buffer_match_data.php', 'addons/flexible_import/datahub/interim_buffer_match_data.php'),
        ...
        array('replace', 'admin/dh_set_match_items_count.php', 'addons/flexible_import/datahub/set_match_items_count.php'),
        ...
        array('replace', 'admin/datahub_transfer_after_import_reduced.php', 'addons/flexible_import/datahub/transfer_after_import_reduced.php'),
        array('replace', 'admin/datahub_transfer_after_import_gen_clean_urls.php', 'addons/flexible_import/datahub/transfer_after_import_gen_clean_urls.php'),
        ...
        array('replace', 'admin/datahub_calc_output_cron.php', 'addons/flexible_import/datahub/calc_output_cron.php'),
        array('replace', 'admin/datahub_correct_images.php', 'addons/flexible_import/datahub/correct_images.php'),
        array('replace', 'admin/datahub_run_cw_update.php', 'addons/flexible_import/datahub/run_cw_update.php'),
        array('replace', 'admin/datahub_run_cw_update_reduced.php', 'addons/flexible_import/datahub/run_cw_update_reduced.php'),
        ...
        array('replace', 'admin/datahub_after_import_linked_items.php', 'addons/flexible_import/datahub/after_import_linked_items.php'),
        array('replace', 'admin/datahub_after_import_clean_urls.php', 'addons/flexible_import/datahub/after_import_clean_urls.php'),
        array('replace', 'admin/datahub_export_new_pos.php', 'addons/flexible_import/datahub/export_new_pos.php'),
        array('replace', 'admin/datahub_export_new_pos_fix.php', 'addons/flexible_import/datahub/export_new_pos_fix.php'),
        array('replace', 'admin/datahub_export_changed_pos.php', 'addons/flexible_import/datahub/export_changed_pos.php'),

        array('replace', 'admin/datahub_export_changed_pos_all.php', 'addons/flexible_import/datahub/export_changed_pos_all.php'),  

        array('replace', 'admin/datahub_export_corrected_pos.php', 'addons/flexible_import/datahub/export_corrected_pos.php'),

        array('replace', 'admin/datahub_export_orphaned_pos.php', 'addons/flexible_import/datahub/export_orphaned_pos.php'),
        array('replace', 'admin/datahub_bevmedia_update.php', 'addons/flexible_import/datahub/bevmedia_update.php'),

        array('replace', 'admin/datahub_soldout_pos_export.php', 'addons/flexible_import/datahub/soldout_pos_export.php'),
        array('replace', 'admin/datahub_update_nonstock.php', 'addons/flexible_import/datahub/update_nonstock.php'),
        array('replace', 'admin/dh_update_nonstock.php', 'addons/flexible_import/datahub/update_nonstock_ajax.php'),
        array('replace', 'admin/datahub_vias.php', 'addons/flexible_import/datahub/vias.php'),
        array('replace', 'admin/datahub_item_edit.php', 'addons/flexible_import/datahub/item_edit.php'),
        array('replace', 'admin/datahub_changed_price_report.php', 'addons/flexible_import/datahub/changed_price_report.php'),
        array('replace', 'admin/datahub_crossed_zero_qty_report.php', 'addons/flexible_import/datahub/crossed_zero_qty_report.php'),
        array('replace', 'admin/datahub_clean_tmp.php', 'addons/flexible_import/datahub/clean_tmp.php'),
        array('replace', 'admin/datahub_dump_items.php', 'addons/flexible_import/datahub/dump_items.php'),
        array('replace', 'admin/datahub_release_lock.php', 'addons/flexible_import/datahub/release_lock.php'),
        array('replace', 'admin/datahub_products_backups.php', 'addons/flexible_import/datahub/products_backups.php'),
        array('replace', 'admin/datahub_errors_report.php', 'addons/flexible_import/datahub/errors_report.php'),
        array('replace', 'admin/datahub_profile_files.php', 'addons/flexible_import/datahub/profile_files.php'),

        array('replace', 'admin/datahub_dbg_sessions.php', 'addons/flexible_import/datahub/dbg_sessions.php'),
        array('replace', 'admin/datahub_dbg_session_log.php', 'addons/flexible_import/datahub/dbg_session_log.php'),

        array('post', 'include/datatable/resources_def.php', 'addons/flexible_import/datahub/datatable_def.php'),
        array('replace', 'admin/datahub_browser.php', 'addons/flexible_import/datahub/browser.php'),
        array('replace', 'admin/datahub_browse_links.php', 'addons/flexible_import/datahub/browse_links.php'),

        array('replace', 'admin/datahub_price_levels.php', 'addons/flexible_import/datahub/price_levels.php')    
    );
    ...
    cw_addons_set_template(
        ...
        array('replace', 'admin/main/datahub_interim_buffer_match.tpl', 'addons/flexible_import/datahub/interim_buffer_match.tpl'),
        ...
        array('replace', 'admin/main/datahub_update_nonstock.tpl', 'addons/flexible_import/datahub/update_nonstock.tpl'), 
        array('replace', 'admin/main/datahub_item_edit.tpl', 'addons/flexible_import/datahub/item_edit.tpl'),

        array('replace', 'admin/main/datahub_duplicate_items_check.tpl', 'addons/flexible_import/datahub/duplicate_items_check.tpl'),

        array('replace', 'admin/main/datahub_products_backups.tpl', 'addons/flexible_import/datahub/products_backups.tpl'), 
        array('replace', 'admin/main/datahub_profile_files.tpl', 'addons/flexible_import/datahub/profile_files.tpl'),

        array('replace', 'admin/main/datahub_browser.tpl', 'addons/flexible_import/datahub/browser.tpl'),

        array('replace', 'admin/main/datahub_price_levels.tpl', 'addons/flexible_import/datahub/price_levels.tpl')  
    );
...
cw_event_listen('on_image_save','sw_save_hub_image');
/*
cw_event_listen('on_cron_regular', 'cw_flexible_import_recurring_imports');
cw_event_listen('on_cron_regular', 'cw_flexible_import_recurring_imports_interim');
cw_event_listen('on_cron_regular', 'cw_flexible_import_recurring_import_beva_monthly');
cw_event_listen('on_cron_daily', 'cw_flexible_import_run_scheduled_monthly_update');
*/
