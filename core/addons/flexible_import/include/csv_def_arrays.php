...
$fi_tables['products_detailed_images'] = 'cw_products_detailed_images';
$fi_tables['categories_images_thumb'] = 'cw_categories_images_thumb';
...
/**/
    ...
    "tmp_load_CATEGORIES_EXTRA_FIELD_VALUES"=>1,
...
$csvxc_field_types = array(
    ...
    'default_CATEGORIESS_EXTRA_FIELD_VALUES' => "text NOT NULL DEFAULT ''",
    'cw_datahub_import_buffer.`custom_field_1`' => "text NOT NULL DEFAULT ''"
);
...
$csvxc_images_translate_path = array(
    ...
    'tmp_load_DETAILED_IMAGES_IMAGE1' => array('dir' => 'products_detailed_images'),
    'tmp_load_DETAILED_IMAGES_IMAGE2' => array('dir' => 'products_detailed_images'),
    'tmp_load_DETAILED_IMAGES_IMAGE3' => array('dir' => 'products_detailed_images'),
    'tmp_load_DETAILED_IMAGES_IMAGE4' => array('dir' => 'products_detailed_images'),
    'tmp_load_DETAILED_IMAGES_IMAGE5' => array('dir' => 'products_detailed_images')
);
...
$csvxc_fmap['tmp_load_PRODUCTS'] = array(
    ...
    'CATEGORYID' => array('field'=>'category_id', 'table'=>$fi_tables['products_categories'],
                          'replace_fields' => array('product_id'=>'PRODUCTID','main'=>1,'orderby'=>'PRODUCTS_CATEGORIES_ORDERBY')), 
...
$csvxc_fmap['tmp_load_CATEGORIES_EXTRA_FIELD_VALUES'] = array(
    'CATEGORYID' => array(),
);
