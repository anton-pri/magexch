...
list($products, $navigation, $product_filter) = cw_call('cw_sections_get', array('section' => 'hot_deals', 'data' => $search_data['sections'], '', 'info_type' =>  8+32+128+256+1024));
...
$location[] = array(cw_get_langvar_by_name('lbl_hot_deals'), '');
