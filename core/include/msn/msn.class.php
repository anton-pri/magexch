...
class MezzengerKlient {
	...
	var $done_customer_id=false; // dont do anything until I am logged in
	...
	*/
	...
	function sendplain($mess,$timeout=5){
		/*
	...
	function sendplainSB($mess,$conn,$timeout=5){
		/*
	...
	function addContact($new,$list="FL"){
		...
		*/
		...
		$this->send("ADD $this->trid AL $new $new");
		$this->process($this->receive());
		return $list;
	}
