...
//echo 'show items'.microtime().'<br>';
    $this->_show_item($box, $offset, $context, $media, $postponed_filter);
//echo 'end show items'.microtime().'<br>';
//die;
...
#echo 'page start'.microtime().'<br>';

# kornev, limit the pages number is required
      if ($g_config['pages_limit'] && $i == $g_config['pages_limit']) continue;
