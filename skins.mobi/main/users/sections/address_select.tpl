...
{include file="buttons/button.tpl" button_title=$lng.lbl_save_address onclick="javascript: if ($('#address').validate().form()) submitFormPart('address',cw_register_init);" style='btn'}
{/if}
