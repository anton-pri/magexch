...
<div 
    class="seller_img_add" 
    style="width: {$seller_image_cell_width}px; text-align:center;" 
...
{if $product_images_count gt 0 || (($multiple || $product_images_count le 0) && $file_upload_data_count gt 0)}
<div class="images_saved_container">
    <div class="image_saved" style="width: max-content">
...
{*
{if ($multiple || $product_images_count le 0) && $file_upload_data_count gt 0}
<div class="images_tmp_container">
<div class="image_tmp" style="width: max-content">
    {foreach from=$file_upload_data key=index item=item}
