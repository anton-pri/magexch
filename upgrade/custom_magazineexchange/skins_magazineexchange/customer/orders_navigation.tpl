<div id="customer_orders_navigation">
...
<ul class="pagination">
  {section name=page loop=$end start=$start}
    ...
    {if %page.last%}
      ...
      {if $current_area eq "C" && $count_view_all ne 0 && 0}
	  <li class="paginate_button"><a href="{build_url url=$navigation_script view_all='all'}" title="{$lng.lbl_view_all}" class="page">{$lng.lbl_view_all}</a></li>
      {/if}
