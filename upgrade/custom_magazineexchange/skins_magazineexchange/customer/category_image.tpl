...
{if $main eq "subcategories" && $current_category.category_id eq "293"}
<div class="CategoryTop incomplete" ><img src="{$AltImagesDir}/Automotive_Home_Page_Header.jpg" alt="" /></div>
