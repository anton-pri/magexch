...
{/if}
{/capture}
{include file='common/section.tpl'  title=$lng.lbl_search_products content=$smarty.capture.dialog additional_class='asearch'}
</div>

{cms service_code="search_for_magazine_articles"}
