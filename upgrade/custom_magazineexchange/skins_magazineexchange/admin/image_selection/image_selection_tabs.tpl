<div class="box image_popup" style="padding-left:10%; padding-right:10%;">
<div style="padding-left:20px; border-style: solid; border-color:#FECC05; padding-bottom:20px; border-top-width:25px; border-bottom-width:0; border-right-width:25px; border-left-width:25px;">
