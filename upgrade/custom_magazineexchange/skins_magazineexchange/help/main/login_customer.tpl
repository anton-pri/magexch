...
<img style="display: block;
	...
	position: absolute;
	top: 95px;
	width: 514px;" src="{$AltImagesDir}/Customer_Login_Avatar_1.png" width="514" height="263" class="hide_tablet">

	<a href="{$catalogs.customer}/seller/index.php"><img style="display: block;
	left: 420px;
	position: absolute;
	top: 358px;
	width: 514px;" src="{$AltImagesDir}/Customer_Login_Avatar_2.png" alt="Click Here to Login to your SELLER account " width="514" height="125" class="hide_tablet"></a>
</div>
</div>
</div>