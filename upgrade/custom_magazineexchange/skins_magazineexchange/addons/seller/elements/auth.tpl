...
<div class="form-group">
      <label for="email">{$lng.lbl_auth_email}:</label>
...
<div class="form-group" style="float:right;">
    <button onclick="javascript: cw_submit_form('auth_form');" class="btn btn-minw btn-default btn-danger">{$lng.lbl_back_to_site}</button></div>
<br></div>
...
{/capture}
{include file='admin/wrappers/jasellermenu.tpl' title=$lng.lbl_authentication content=$smarty.capture.menu style=green options=password_recovery}
</div>