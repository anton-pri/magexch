...
<div style="text-align: center;">{if $shopfront.holiday_settings eq 1}<img src="/cw/xc_skin/images/Help_Section_Images/Holiday_Settings_ON.gif" width="203" height="173">{else}<img src="/cw/xc_skin/images/Help_Section_Images/Holiday_Settings_OFF.gif" width="203" height="173">{/if}
<br><a href='index.php?target=seller_shopfront' target='blank' >{$lng.lbl_hs_change}</a></div>
    </div>
