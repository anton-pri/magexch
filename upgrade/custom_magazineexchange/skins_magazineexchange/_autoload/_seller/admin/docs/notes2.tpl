...
<br><br>
<a class="btn btn-minw btn-default btn-green push-20 " href="index.php?target={$current_target}&doc_id={$doc_id}&mode=print_label" target=_blank>{$lng.lbl_print_label}</a>{$lng.lbl_print_label_tooltip}<br><br>
...
{if $doc.status eq 'P'}
<input type='hidden' name='make_despatch' value='' />
<a class="btn btn-minw btn-default btn-green push-20" href="javascript: document.status_form.make_despatch.value='Y'; cw_submit_form('status_form');" ><h8 style="font-size:9pt; font-weight:300;">Posting Date: {$smarty.now|date_format:"%d-%m-%y"}</h8><br><h3>Confirm Full Despatch</h3></a>

{* Confirm Despatch Box cont. - Order Notes if Not Despatched *}  
<div style="float:left; margin-left:48px; margin-top:10px;"><textarea style="background-color:#FAFFBD; width:200px; resize: none; overflow: hidden; padding: 1px 12px; height:24px;" name="notes" class="form-control" placeholder="Tracking Info. (optional)">{$doc.info.notes|escape:quotes}</textarea><a class="ProductBlue" style="font-weight:600;"></div><div style="margin-right:48px; padding-top:12px; float:right;"><a href="javascript: cw_submit_form('status_form');">Update</a></div>
...
<div style="float:left; margin-left:48px; margin-top:10px;"><textarea style="background-color:#FAFFBD; width:200px; resize: none; overflow: hidden; padding: 1px 12px; height:24px;" name="notes" class="form-control" placeholder="Tracking Info. (optional)">{$doc.info.notes|escape:quotes}</textarea><a class="ProductBlue" style="font-weight:600;"></div><div style="margin-right:48px; padding-top:2px; float:right;"><a href="javascript: cw_submit_form('status_form');">Update</a></div>
