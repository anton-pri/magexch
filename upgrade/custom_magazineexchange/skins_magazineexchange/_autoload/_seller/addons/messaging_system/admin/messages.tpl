...
{if $mode eq "sent"}
<div class="block-header bg-green"><h3 style="text-align: center;" class="block-title">MESSAGES - {$lng.lbl_sent}</h3></div>
{elseif $mode eq "archive"}
<div class="block-header bg-green"><h3 style="text-align: center;" class="block-title">MESSAGES - {$lng.lbl_archive}</h3></div>
{else}
<div class="block-header bg-green"><h3 style="text-align: center;" class="block-title">MESSAGES - {$lng.lbl_avail_type_incoming}</h3></div>
{/if} 
<div style="width:100%;" class="jasellerblock-content">
      <div class="row">
...
<tr>
                <th>&nbsp;</th>
                <th>{$lng.lbl_sending_date}</th>
                <th>{if $mode eq "sent"}{$lng.lbl_recipient}{else}{$lng.lbl_sender}{/if}</th>
                <th>{$lng.lbl_subject}</th>
                <th>{$lng.lbl_read_status}</th>
                {if $mode eq "sent"}
                <th>{$lng.lbl_recipient_status}</th>
                {/if}
            </tr>
