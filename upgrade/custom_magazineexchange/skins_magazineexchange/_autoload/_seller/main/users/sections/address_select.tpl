...
{include file="admin/buttons/button.tpl" button_title=$lng.lbl_save_address onclick="javascript: if ($('#address').validate().form()) submitFormPart('address',cw_register_init);" style="push-5-r btn-green"}
</div>
{/if}
