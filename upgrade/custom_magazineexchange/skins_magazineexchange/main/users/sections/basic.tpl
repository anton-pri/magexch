...
{if $current_area eq 'A' && $userinfo.customer_id}
<div class="profile_input_field_0">
...
<div class="profile_input_field_1">
...
{if $current_area eq 'C' && $userinfo.customer_id && $enable_seperate_page_change_password eq 'Y'}
    <a href="index.php?target=change_password" class="change_pass">{$lng.lbl_chpass}</a>
{else}
    <div class="profile_input_field_{$profile_fields.basic.password.is_required}" id="pw-inp-field">
    ...
    <div class="profile_input_field_{$profile_fields.basic.password.is_required}" id="pw-conf-field">
...
<div class="profile_input_field_{$profile_fields.basic.membership_id.is_required}">
...
<div class="profile_input_field_{$profile_fields.basic.tax_number.is_required}">
...
{/if}
<div class="profile_input_field_{$profile_fields.basic.chamber_certificate.is_required}">
    <label>{$lng.lbl_chamber_certificate}</label>
...
<div class="profile_input_field_{$profile_fields.basic.language.is_required}">
