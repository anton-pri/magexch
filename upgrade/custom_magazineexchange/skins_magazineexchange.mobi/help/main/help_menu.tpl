<div class="help_column" id="help_menu">
...
$(document).ready(function() {
  $("#help_menu .ProductDetailsTitle").click(function() {
    $("#help_menu .toogle_menu").toggle();
    $("#help_menu .ProductDetailsTitle").toggleClass("opened");
  });
});
</script>
{/literal}