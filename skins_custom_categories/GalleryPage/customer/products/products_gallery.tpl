...
<div class="prod_gallery" id="product_list" template="products_gallery">
      ...
      <div class="prod_border">
        <div class="g-image">
            <a href="{pages_url var="product" product_id=$product.product_id page=$navigation_page}" class="image">
              {include file='common/product_image.tpl' image=$product.image_thumb product_id=$product.product_id html_height=$config.Appearance.products_images_thumb_height no_img_id='Y' width=250 height=140}
            </a>
        </div>
